    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        private void SeedData(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<KodeBarang>().HasData(
                ...
                new KodeBarang { Id = 103, KodeGolongan = "4", KodeBidang = "01", KodeKelompok = "01", KodeSubKelompok = "01", KodeBarangValue = "002", UraianBarang = "Gedung Kantor Semi Permanen" },
                new KodeBarang { Id = 104, KodeGolongan = "4", KodeBidang = "01", KodeKelompok = "02", KodeSubKelompok = "00", KodeBarangValue = "000", UraianBarang = "Bangunan Gedung Tempat Pendidikan" },
                new KodeBarang { Id = 105, KodeGolongan = "4", KodeBidang = "01", KodeKelompok = "02", KodeSubKelompok = "01", KodeBarangValue = "000", UraianBarang = "Gedung Perkuliahan" },
                new KodeBarang { Id = 106, KodeGolongan = "4", KodeBidang = "01", KodeKelompok = "02", KodeSubKelompok = "01", KodeBarangValue = "001", UraianBarang = "Gedung Kuliah A" },
                new KodeBarang { Id = 107, KodeGolongan = "4", KodeBidang = "01", KodeKelompok = "02", KodeSubKelompok = "01", KodeBarangValue = "002", UraianBarang = "Gedung Kuliah B" },
                new KodeBarang { Id = 108, KodeGolongan = "4", KodeBidang = "01", KodeKelompok = "02", KodeSubKelompok = "01", KodeBarangValue = "003", UraianBarang = "Gedung Laboratorium" },
                ...
                new KodeBarang { Id = 123, KodeGolongan = "5", KodeBidang = "01", KodeKelompok = "01", KodeSubKelompok = "01", KodeBarangValue = "001", UraianBarang = "Jalan Utama Kampus" },
                new KodeBarang { Id = 124, KodeGolongan = "5", KodeBidang = "01", KodeKelompok = "01", KodeSubKelompok = "01", KodeBarangValue = "002", UraianBarang = "Jalan Lingkungan Kampus" },
                new KodeBarang { Id = 125, KodeGolongan = "5", KodeBidang = "02", KodeKelompok = "00", KodeSubKelompok = "00", KodeBarangValue = "000", UraianBarang = "Bangunan Air/Irigasi" },
                new KodeBarang { Id = 126, KodeGolongan = "5", KodeBidang = "02", KodeKelompok = "01", KodeSubKelompok = "00", KodeBarangValue = "000", UraianBarang = "Bangunan Air Irigasi" },
                new KodeBarang { Id = 127, KodeGolongan = "5", KodeBidang = "02", KodeKelompok = "01", KodeSubKelompok = "01", KodeBarangValue = "000", UraianBarang = "Saluran Irigasi" },
                new KodeBarang { Id = 128, KodeGolongan = "5", KodeBidang = "02", KodeKelompok = "01", KodeSubKelompok = "01", KodeBarangValue = "001", UraianBarang = "Saluran Drainase Kampus" },
                new KodeBarang { Id = 129, KodeGolongan = "5", KodeBidang = "03", KodeKelompok = "00", KodeSubKelompok = "00", KodeBarangValue = "000", UraianBarang = "Instalasi" },
                new KodeBarang { Id = 130, KodeGolongan = "5", KodeBidang = "03", KodeKelompok = "01", KodeSubKelompok = "00", KodeBarangValue = "000", UraianBarang = "Instalasi Air Bersih" },
                new KodeBarang { Id = 131, KodeGolongan = "5", KodeBidang = "03", KodeKelompok = "01", KodeSubKelompok = "01", KodeBarangValue = "000", UraianBarang = "Instalasi Air Minum" },
                new KodeBarang { Id = 132, KodeGolongan = "5", KodeBidang = "03", KodeKelompok = "01", KodeSubKelompok = "01", KodeBarangValue = "001", UraianBarang = "Instalasi Air Bersih Kampus" },
                new KodeBarang { Id = 133, KodeGolongan = "5", KodeBidang = "04", KodeKelompok = "00", KodeSubKelompok = "00", KodeBarangValue = "000", UraianBarang = "Jaringan" },
                new KodeBarang { Id = 134, KodeGolongan = "5", KodeBidang = "04", KodeKelompok = "01", KodeSubKelompok = "00", KodeBarangValue = "000", UraianBarang = "Jaringan Listrik" },
                new KodeBarang { Id = 135, KodeGolongan = "5", KodeBidang = "04", KodeKelompok = "01", KodeSubKelompok = "01", KodeBarangValue = "000", UraianBarang = "Jaringan Listrik Kampus" },
                ...
                new KodeBarang { Id = 143, KodeGolongan = "6", KodeBidang = "01", KodeKelompok = "01", KodeSubKelompok = "01", KodeBarangValue = "001", UraianBarang = "Buku Referensi Teknik" },
                new KodeBarang { Id = 144, KodeGolongan = "6", KodeBidang = "01", KodeKelompok = "01", KodeSubKelompok = "01", KodeBarangValue = "002", UraianBarang = "Buku Referensi Ekonomi" },
                new KodeBarang { Id = 145, KodeGolongan = "6", KodeBidang = "01", KodeKelompok = "01", KodeSubKelompok = "01", KodeBarangValue = "003", UraianBarang = "Buku Referensi Hukum" },
                new KodeBarang { Id = 146, KodeGolongan = "6", KodeBidang = "01", KodeKelompok = "01", KodeSubKelompok = "01", KodeBarangValue = "004", UraianBarang = "Jurnal Ilmiah" },
                new KodeBarang { Id = 147, KodeGolongan = "6", KodeBidang = "02", KodeKelompok = "00", KodeSubKelompok = "00", KodeBarangValue = "000", UraianBarang = "Barang Bercorak Kesenian" },
                new KodeBarang { Id = 148, KodeGolongan = "6", KodeBidang = "02", KodeKelompok = "01", KodeSubKelompok = "00", KodeBarangValue = "000", UraianBarang = "Barang Bercorak Kebudayaan" },
                new KodeBarang { Id = 149, KodeGolongan = "6", KodeBidang = "02", KodeKelompok = "01", KodeSubKelompok = "01", KodeBarangValue = "000", UraianBarang = "Lukisan" },
                new KodeBarang { Id = 150, KodeGolongan = "6", KodeBidang = "02", KodeKelompok = "01", KodeSubKelompok = "01", KodeBarangValue = "001", UraianBarang = "Lukisan Dinding" },
                new KodeBarang { Id = 151, KodeGolongan = "6", KodeBidang = "02", KodeKelompok = "01", KodeSubKelompok = "01", KodeBarangValue = "002", UraianBarang = "Patung Kampus" }
            );
        }
    }
}
